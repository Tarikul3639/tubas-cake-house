        ...
        <div className="flex items-center gap-2 group cursor-pointer">
          <div className="relative">
            ...
            <div className="w-10 h-10 bg-linear-to-br from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-pink-100 group-hover:scale-105 group-hover:rotate-3 transition-all duration-300">
              ...
              <CakeSlice size={24} strokeWidth={2.5} className="drop-shadow-sm" />
            </div>
          </div>
          ...
          <div className="hidden md:block leading-tight">
            <h1 className="text-xl font-black tracking-tighter flex items-center gap-1">
              ...
              <span className="bg-linear-to-r from-pink-600 to-rose-500 bg-clip-text text-transparent">Bakery</span>
            </h1>
            <div className="flex items-center gap-1.5">
               <span className="text-[9px] text-slate-400 font-bold uppercase tracking-[0.2em]">Admin Suite</span>
               <div className="w-1 h-1 bg-pink-300 rounded-full"></div>
               <span className="text-[9px] text-pink-400 font-bold uppercase tracking-widest">Premium</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-xl mx-6 hidden sm:block">
        <div className="relative group">
          ...
          <div className="absolute inset-y-0 right-3 flex items-center">
            <kbd className="hidden lg:inline-block px-1.5 py-0.5 text-[10px] font-medium text-slate-400 bg-white border border-slate-200 rounded-md">⌘K</kbd>
          </div>
        </div>
      </div>
        ...
        <div className="relative">
          <button 
            ...
            className={cn(
              ...
              showNotifications ? "bg-pink-50 text-pink-600" : "text-slate-500 hover:bg-slate-100"
            )}
          >
          ...
          {showNotifications && (
            <div ref={notificationsRef} className="absolute right-0 mt-3 w-80 bg-white border border-slate-200 rounded-3xl shadow-2xl p-4 animate-in fade-in zoom-in duration-200 origin-top-right">
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-slate-800">Recent Alerts</h3>
                <button onClick={() => setShowNotifications(false)} className="text-slate-400 hover:text-slate-600 text-xs">Mark all as read</button>
              </div>
              <div className="space-y-3">
                <div className="p-3 bg-slate-50 rounded-2xl text-xs text-slate-600 border border-slate-100">
                   🍰 <span className="font-bold text-slate-800">New Order!</span> #TCH-1092 just arrived.
                </div>
                <div className="p-3 bg-slate-50 rounded-2xl text-xs text-slate-600 border border-slate-100">
                   ⚠️ <span className="font-bold text-slate-800">Stock Alert:</span> Vanilla Sponge is low.
                </div>
              </div>
            </div>
          )}
        ...
        <div className="flex items-center pl-1">
          <button className="flex items-center gap-2 p-1 pr-3 hover:bg-slate-50 rounded-2xl transition-all border border-transparent hover:border-slate-100">
            <Avatar className="h-9 w-9 ring-2 ring-pink-50">
              ...
              <AvatarFallback className="bg-pink-100 text-pink-600 text-xs font-bold">TK</AvatarFallback>
            </Avatar>
            <div className="text-left hidden lg:block">
              <p className="text-xs font-bold text-slate-800">Tuba Khan</p>
              <p className="text-[9px] text-pink-500 font-bold uppercase tracking-tighter">Super Admin</p>
            </div>
          </button>
        </div>
      </div>
